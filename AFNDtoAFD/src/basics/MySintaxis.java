...
public class MySintaxis {
     ...
     */
    //() por {} y[] por <>
     public MySintaxis( String Sintaxis, MyListArgs Parametros){ //
     ...
     private String RevisarTipoDato (String Token, String Tipo){   
       ...
       if (Tipo.startsWith("'") && Tipo.endsWith("'") && Tipo.length()>3){ //tipo expresion regular
         Tipo = Tipo.replaceAll("<", "[").replaceAll(">","]").replaceAll("\\{","(").replaceAll("}", ")").substring(1, Tipo.length()-1);
         
         if (Param.Args.get(Token).matches(Tipo))
            return ("Se esperaba una cadena con el formato de expresion regular ["+ Tipo +"] para la etiqueta [" + Token + "] pero se encontró [" + Param.Args.get(Token)+"]");   
         
       }else if (Tipo.equalsIgnoreCase("str")){//tipo cadena
         if (Param.Args.get(Token).equals(""))
            return ("Se esperaba una cadena para la etiqueta [" + Token + "] pero se encontró [" + Param.Args.get(Token)+"]");   
         
       }else if (Tipo.equalsIgnoreCase("int")){//tipo entero
       ...
       }else if (Tipo.equalsIgnoreCase("float")){//tipo flotante
       ...
       }else if (Tipo.equalsIgnoreCase("bool")){//tipo booleano
       ...
       }else if (Tipo.equalsIgnoreCase("date")){//tipo fecha
