 ...
 */
public MyListArgs(String []Strings){
 ...
 */
public boolean  AddArgsFromFile (String FileName ){
 ManejoArchivos IO = new ManejoArchivos();
 ...
 */
public String   ValueArgsAsString( String Label , String Default){  
 ...
 */
public int      ValueArgsAsInteger( String Label, int Default ){
...
/**
 * Se utiliza para leer parámetros de tipo double, primero se busca la cadena
 * en la lista de cadenas y se regresa la siguiente cadena como double
 * @param Label párametro a leer
 * @param Default Valor por default que se regresa si no se encuentra Label en el arreglo
 * @return el valor del parámetro como un real (double)
 */
public double   ValueArgsAsDouble( String Label, double Default ){
   return( Args.containsKey(Label) ? Double.valueOf(Args.get(Label)) : Default );
}
