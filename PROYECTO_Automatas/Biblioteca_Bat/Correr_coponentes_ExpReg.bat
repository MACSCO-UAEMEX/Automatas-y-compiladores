...
TITLE Procesando Expresion Regular

REM "Despliega las instrucciones"
ECHO Este archivo bat ejecuta los componentes para procesar una Expresion Regular
ECHO.
...
ECHO.
ECHO Escribir una Expresion Regular en el Archivo Cadena.txt
ECHO.
PAUSE
